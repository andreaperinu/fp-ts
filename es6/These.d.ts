...
declare const foldMap: <M>(M: import('./Monoid').Monoid<M>) => <A>(f: (a: A) => M) => <E>(fa: These<E, A>) => M
declare const map: <A, B>(f: (a: A) => B) => <E>(fa: These<E, A>) => These<E, B>
declare const mapLeft: <E, G>(f: (e: E) => G) => <A>(fa: These<E, A>) => These<G, A>
declare const reduce: <A, B>(b: B, f: (b: B, a: A) => B) => <E>(fa: These<E, A>) => B
declare const reduceRight: <A, B>(b: B, f: (a: A, b: B) => B) => <E>(fa: These<E, A>) => B
export {
  /**
   * @since 2.0.0
   */
