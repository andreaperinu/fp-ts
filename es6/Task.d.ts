...
declare const apFirst: <B>(fb: Task<B>) => <A>(fa: Task<A>) => Task<A>
declare const apSecond: <B>(fb: Task<B>) => <A>(fa: Task<A>) => Task<B>
declare const chain: <A, B>(f: (a: A) => Task<B>) => (ma: Task<A>) => Task<B>
declare const chainFirst: <A, B>(f: (a: A) => Task<B>) => (ma: Task<A>) => Task<A>
declare const flatten: <A>(mma: Task<Task<A>>) => Task<A>
declare const map: <A, B>(f: (a: A) => B) => (fa: Task<A>) => Task<B>
export {
  /**
   * @since 2.0.0
   */
