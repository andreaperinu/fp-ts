...
declare const apFirst: <B>(fb: IO<B>) => <A>(fa: IO<A>) => IO<A>
declare const apSecond: <B>(fb: IO<B>) => <A>(fa: IO<A>) => IO<B>
declare const chain: <A, B>(f: (a: A) => IO<B>) => (ma: IO<A>) => IO<B>
declare const chainFirst: <A, B>(f: (a: A) => IO<B>) => (ma: IO<A>) => IO<A>
declare const flatten: <A>(mma: IO<IO<A>>) => IO<A>
declare const map: <A, B>(f: (a: A) => B) => (fa: IO<A>) => IO<B>
export {
  /**
   * @since 2.0.0
   */
