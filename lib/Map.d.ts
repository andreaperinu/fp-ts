...
declare const filterMap: <A, B>(f: (a: A) => Option<B>) => <E>(fa: Map<E, A>) => Map<E, B>
declare const map: <A, B>(f: (a: A) => B) => <E>(fa: Map<E, A>) => Map<E, B>
...
declare const compact: <E, A>(fa: Map<E, Option<A>>) => Map<E, A>
declare const separate: <E, A, B>(
