...
declare const filterMap: <A, B>(f: (a: A) => Option<B>) => <E>(fa: ReadonlyMap<E, A>) => ReadonlyMap<E, B>
declare const map: <A, B>(f: (a: A) => B) => <E>(fa: ReadonlyMap<E, A>) => ReadonlyMap<E, B>
...
declare const compact: <E, A>(fa: ReadonlyMap<E, Option<A>>) => ReadonlyMap<E, A>
declare const separate: <E, A, B>(fa: ReadonlyMap<E, Either<A, B>>) => Separated<ReadonlyMap<E, A>, ReadonlyMap<E, B>>
export {
  /**
   * @since 2.5.0
   */
