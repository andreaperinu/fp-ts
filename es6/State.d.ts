...
declare const apFirst: <E, B>(fb: State<E, B>) => <A>(fa: State<E, A>) => State<E, A>
declare const apSecond: <E, B>(fb: State<E, B>) => <A>(fa: State<E, A>) => State<E, B>
declare const chain: <E, A, B>(f: (a: A) => State<E, B>) => (ma: State<E, A>) => State<E, B>
declare const chainFirst: <E, A, B>(f: (a: A) => State<E, B>) => (ma: State<E, A>) => State<E, A>
declare const flatten: <E, A>(mma: State<E, State<E, A>>) => State<E, A>
declare const map: <A, B>(f: (a: A) => B) => <E>(fa: State<E, A>) => State<E, B>
export {
  /**
   * @since 2.0.0
   */
