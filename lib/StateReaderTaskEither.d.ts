...
declare const mapLeft: <E, G>(
  f: (e: E) => G
) => <S, R, A>(fa: StateReaderTaskEither<S, R, E, A>) => StateReaderTaskEither<S, R, G, A>
declare const fromEither: <S, R, E, A>(ma: Either<E, A>) => StateReaderTaskEither<S, R, E, A>
declare const fromOption: <E>(
  onNone: () => E
) => <S, R, A>(ma: import('./Option').Option<A>) => StateReaderTaskEither<S, R, E, A>
